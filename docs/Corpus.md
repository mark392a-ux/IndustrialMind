...
**32 of 37 documents are bundled in [`Sample_Corpus/`](sample_corpus/).** The 4 excluded documents are commercial OEM manufacturer manuals — cited here by title for transparency, but not redistributed. See [Redistribution Notes](#redistribution-notes) below.
